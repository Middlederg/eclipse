namespace Eclipse.Web
{
    public class Styles
    {
        ...
        private const string Button = $"font-semibold outline-none focus:outline-none rounded-sm " +
            $"px-2 text-sm uppercase outline-none focus:outline-none flex items-center justify-center";
